...
export default function Login() {
  ...
  async function handleLogin() {
    ...
    try {
      ...
      // store auth token and refresh token, set default header for future requests
      ...
      console.error('Login error status', status, 'body', body, error);
      const message = body || "Erro no login";
